 ...
 * @author Alex
 */
public class EmailReceiveUtilsTest extends BaseTestCase {
	/**
	 * Unit tests for {@link EmailReceiveUtils#getMessageText(javax.mail.Multipart, String)}.
	...
	public void testGetMessageTextFromMultipart() throws MessagingException, IOException {
		...
		mult.addBodyPart(bp);
		String text = EmailReceiveUtils.getMessageText(mult, desiredContentType);
		...
		mult.addBodyPart(bp);
		text = EmailReceiveUtils.getMessageText(mult, desiredContentType);
	...
	/**
	 * Unit tests for {@link EmailReceiveUtils#getSender(javax.mail.Message)}.
	 * @throws MessagingException 
	 */
	public void testGetSender() throws MessagingException {
		...
		String sender = EmailReceiveUtils.getSender(message);
		...
		sender = EmailReceiveUtils.getSender(message);
	...
	/**
	 * Unit tests for {@link EmailReceiveUtils#getMessageText(javax.mail.Message)}.
	 * @throws MessagingException 
	 * @throws IOException 
	 */
